...
- ba6c94c: feat: custom fields — `TracioConfig.fields` attaches key → value pairs to every event
...
- 12d4ccd: fix: wrapper lifecycle — SSR context isolation, a visible missing key, Angular teardown
